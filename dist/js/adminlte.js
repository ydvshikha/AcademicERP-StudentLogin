  ...
  var TodoList = /*#__PURE__*/function () {
    ...
    TodoList._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        ...
        var _options = $__default.extend({}, Default$9, typeof config === 'object' ? config : data);

        var plugin = new TodoList($__default(this), _options);
        $__default(this).data(DATA_KEY$b, typeof config === 'object' ? config : data);
